...
function raycast() {
    ...
    const intersectionPoint = (intersects.length > 0) ? intersects[0].point : undefined;
    scene.update(intersectionPoint);
}

function touchWrapper(e, wrapped) {
    scene.setMobileFlag(true);
...
function addEventListeners() {
    ...
    canvas.addEventListener('touchstart', e => touchWrapper(e, onMouseDown));
    canvas.addEventListener('touchend', e => touchWrapper(e, onMouseUp));
